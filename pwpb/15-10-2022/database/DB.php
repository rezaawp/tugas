...
class DB
{
    ...
    {
        // mencari tau dulu key mana yang a_i;
        $field_ai = null;
        ...
        $fields = array_filter($fields, fn ($f) => $f !== $field_ai);
    ...
    public function update($data)
    {
        ...
        $this->query("UPDATE $this->table SET $fieldUpdate WHERE $this->keyUpdate = '$this->valueUpdate'");
        return true;
    }
